...
// Through concatenation, we are able to combine string and number data types together
// Type coercion converts the number data type to a string data type so that
// the two can be combined. The end result will log as a string.
